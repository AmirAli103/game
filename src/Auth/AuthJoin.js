...
export const AuthJoin = () => {
  ...
  //const [errorMessage] = useState("Room does not exist");
  //const [errorMessage] = useState( "Already in room");
  //const [errorMessage] = useState("Max player limit reached");
  //const [errorMessage] = useState("Game already started");
